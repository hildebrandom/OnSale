...
namespace OnSale.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Hilder", "Montoya", "hilderbrand2007@hotmail.com", "30053374201", "Calle Luna Calle Sol", UserType.Admin);
        ...
        private async Task CheckProductsAsync()
        {
            ...
            {
                User user = await _userHelper.GetUserAsync("hilderbrand2007@hotmail.com");
